      ...
      <html>
        <head>
          ...
          <style>
            ...
            .close { margin-top: 24px; color: #fff; background: #1a73e8; border: none; border-radius: 6px; padding: 10px 24px; font-size: 1em; cursor: pointer; transition: background 0.2s; }
            .close:hover { background: #1557b0; }
          </style>
        </head>
        <body>
          <div class="container">
            <img class="gs-logo" src="https://ssl.gstatic.com/docs/presentations/images/slides_2022q4_48dp.png" alt="Google Slides Logo" />
            <h1>Autenticado!</h1>
            <p>Você foi autenticado com sucesso no Google Slides.<br>Você pode fechar esta página agora.</p>
