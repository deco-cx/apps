...
import type { GetUserQuery, GetUserQueryVariables } from '../utils/graphql/storefront.graphql.gen.ts'
 ...
 */
const userLoader = async (_props: unknown, req: Request, ctx: AppContext): Promise<Person | null> => {
    ...
    try {
        ...
        return {
            ...
            gender: customer?.gender === 'Masculino' ? 'https://schema.org/Male' : 'https://schema.org/Female',
        }
    } catch (e) {
        return null
    }
