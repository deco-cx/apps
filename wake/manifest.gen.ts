...
import * as $$$$$$$$$4 from "./actions/cart/addCoupon.ts";
...
const manifest = {
  "loaders": {
    ...
    "wake/loaders/productListingPage.ts": $$$0,
    "wake/loaders/proxy.ts": $$$1,
  },
  "actions": {
    "wake/actions/cart/addCoupon.ts": $$$$$$$$$4,
    "wake/actions/cart/addItem.ts": $$$$$$$$$0,
    "wake/actions/cart/addItems.ts": $$$$$$$$$1,
