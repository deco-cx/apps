...
const action = async (_props: unknown, req: Request, ctx: AppContext): Promise<Partial<CheckoutFragment>> => {
    ...
    const data = await storefront.query<RemoveCouponMutation, RemoveCouponMutationVariables>(
        {
