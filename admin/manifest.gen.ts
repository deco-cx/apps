...
import * as $$$$$$$$$7 from "./actions/github/setStatus.ts";
import * as $$$$$$$$$8 from "./actions/github/webhooks/broker.ts";
import * as $$$$$$$$$9 from "./actions/pages/delete.ts";
import * as $$$$$$$$$10 from "./actions/pages/new.ts";
import * as $$$$$$$$$11 from "./actions/pages/publish.ts";
import * as $$$$$$$$$12 from "./actions/releases/fork.ts";
import * as $$$$$$$$$13 from "./actions/sites/linkRepo.ts";
import * as $$$$$$$$$14 from "./actions/sites/newDomain.ts";
import * as $$$$$$$$$15 from "./actions/sites/unlinkRepo.ts";
...
const manifest = {
  ...
  "actions": {
    ...
    "deco-sites/admin/actions/github/setStatus.ts": $$$$$$$$$7,
    "deco-sites/admin/actions/github/webhooks/broker.ts": $$$$$$$$$8,
    "deco-sites/admin/actions/pages/delete.ts": $$$$$$$$$9,
    "deco-sites/admin/actions/pages/new.ts": $$$$$$$$$10,
    "deco-sites/admin/actions/pages/publish.ts": $$$$$$$$$11,
    "deco-sites/admin/actions/releases/fork.ts": $$$$$$$$$12,
    "deco-sites/admin/actions/sites/linkRepo.ts": $$$$$$$$$13,
    "deco-sites/admin/actions/sites/newDomain.ts": $$$$$$$$$14,
    "deco-sites/admin/actions/sites/unlinkRepo.ts": $$$$$$$$$15,
  },
