...
import * as $$$5 from "./loaders/blocks/published.ts";
import * as $$$6 from "./loaders/state.ts";
import * as $$$7 from "./loaders/pages/list.ts";
import * as $$$$$$$$$0 from "./actions/blocks/restore.ts";
import * as $$$$$$$$$1 from "./actions/blocks/safeDelete.ts";
import * as $$$$$$$$$2 from "./actions/blocks/newRevision.ts";
import * as $$$$$$$$$3 from "./actions/blocks/publish.ts";
import * as $$$$$$$$$4 from "./actions/blocks/delete.ts";
import * as $$$$$$$$$5 from "./actions/pages/new.ts";
...
const manifest = {
  "loaders": {
    ...
    "deco-sites/admin/loaders/blocks/published.ts": $$$5,
  ...
  "actions": {
    ...
    "deco-sites/admin/actions/blocks/newRevision.ts": $$$$$$$$$2,
    "deco-sites/admin/actions/blocks/publish.ts": $$$$$$$$$3,
    "deco-sites/admin/actions/blocks/restore.ts": $$$$$$$$$0,
    "deco-sites/admin/actions/blocks/safeDelete.ts": $$$$$$$$$1,
    "deco-sites/admin/actions/pages/delete.ts": $$$$$$$$$7,
    "deco-sites/admin/actions/pages/new.ts": $$$$$$$$$5,
