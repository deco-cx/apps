...
import * as $$$0 from "./loaders/blocks/published.ts";
...
import * as $$$$$$$$$0 from "./actions/pages/publish.ts";
...
const manifest = {
  "loaders": {
    ...
    "deco-sites/admin/loaders/blocks/published.ts": $$$0,
  ...
  "actions": {
    ...
    "deco-sites/admin/actions/pages/publish.ts": $$$$$$$$$0,
  },
