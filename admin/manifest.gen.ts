...
import * as $$$6 from "./loaders/k8s/builderConfig.ts";
import * as $$$7 from "./loaders/k8s/siteState.ts";
import * as $$$8 from "./loaders/k8s/runnerConfig.ts";
...
import * as $$$$$$$$$5 from "./actions/k8s/setSiteState.ts";
import * as $$$$$$$$$6 from "./actions/k8s/newService.ts";
import * as $$$$$$$$$7 from "./actions/k8s/build.ts";
import * as $$$$$$$$$8 from "./actions/sites/newRelease.ts";
import * as $$$$$$$$$9 from "./actions/sites/newDeployment.ts";
...
const manifest = {
  "loaders": {
    ...
    "deco-sites/admin/loaders/k8s/builderConfig.ts": $$$6,
    "deco-sites/admin/loaders/k8s/runnerConfig.ts": $$$8,
    "deco-sites/admin/loaders/k8s/siteState.ts": $$$7,
  ...
  "actions": {
    ...
    "deco-sites/admin/actions/sites/newDeployment.ts": $$$$$$$$$9,
    "deco-sites/admin/actions/sites/newDomain.ts": $$$$$$$$$10,
    "deco-sites/admin/actions/sites/newRelease.ts": $$$$$$$$$8,
  },
