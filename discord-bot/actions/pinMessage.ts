...
export interface Props {
  ...
  /**
   * @title Message ID
   * @description ID da mensagem a ser fixada
   */
  messageId: string;
}
...
/**
 * @title Pin Message
 * @description Pin a message in a Discord channel using Bot Token
 */
export default async function pinMessage(
  ...
  // Pin message
  const response = await client["PUT /channels/:channel_id/pins/:message_id"]({
