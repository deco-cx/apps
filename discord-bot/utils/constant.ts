...
export const DISCORD_ERROR_MESSAGES = {
  "UNAUTHORIZED": "Bot token inválido ou expirado. Verifique suas credenciais do Discord.",
  "FORBIDDEN": "Acesso negado. O bot não tem permissões necessárias para esta operação.",
  "NOT_FOUND": "Recurso não encontrado. Verifique o ID do canal, servidor ou mensagem.",
  ...
  "MISSING_PERMISSIONS": "O bot não possui as permissões necessárias no servidor.",
