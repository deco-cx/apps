...
import * as $$$$$$$$$1 from "./actions/authentication/accessKeySignIn.ts";
import * as $$$$$$$$$2 from "./actions/authentication/classicSignIn.ts";
import * as $$$$$$$$$3 from "./actions/authentication/logout.ts";
import * as $$$$$$$$$4 from "./actions/authentication/recoveryPassword.ts";
import * as $$$$$$$$$5 from "./actions/authentication/resetPassword.ts";
import * as $$$$$$$$$6 from "./actions/authentication/sendEmailVerification.ts";
import * as $$$$$$$$$7 from "./actions/authentication/startAuthentication.ts";
import * as $$$$$$$$$8 from "./actions/cart/addItems.ts";
import * as $$$$$$$$$9 from "./actions/cart/addOfferings.ts";
import * as $$$$$$$$$10 from "./actions/cart/clearOrderformMessages.ts";
...
import * as $$$$$$$$$14 from "./actions/cart/removeOffering.ts";
import * as $$$$$$$$$15 from "./actions/cart/simulation.ts";
import * as $$$$$$$$$16 from "./actions/cart/updateAttachment.ts";
import * as $$$$$$$$$17 from "./actions/cart/updateCoupons.ts";
import * as $$$$$$$$$18 from "./actions/cart/updateGifts.ts";
import * as $$$$$$$$$19 from "./actions/cart/updateItemAttachment.ts";
import * as $$$$$$$$$20 from "./actions/cart/updateItemPrice.ts";
import * as $$$$$$$$$21 from "./actions/cart/updateItems.ts";
import * as $$$$$$$$$22 from "./actions/cart/updateProfile.ts";
import * as $$$$$$$$$23 from "./actions/cart/updateUser.ts";
import * as $$$$$$$$$24 from "./actions/masterdata/createDocument.ts";
import * as $$$$$$$$$25 from "./actions/masterdata/updateDocument.ts";
import * as $$$$$$$$$26 from "./actions/newsletter/subscribe.ts";
import * as $$$$$$$$$27 from "./actions/notifyme.ts";
...
const manifest = {
  ...
  "actions": {
    ...
    "vtex/actions/authentication/accessKeySignIn.ts": $$$$$$$$$1,
    "vtex/actions/authentication/classicSignIn.ts": $$$$$$$$$2,
    "vtex/actions/authentication/logout.ts": $$$$$$$$$3,
    "vtex/actions/authentication/recoveryPassword.ts": $$$$$$$$$4,
    "vtex/actions/authentication/resetPassword.ts": $$$$$$$$$5,
    "vtex/actions/authentication/sendEmailVerification.ts": $$$$$$$$$6,
    "vtex/actions/authentication/startAuthentication.ts": $$$$$$$$$7,
    "vtex/actions/cart/addItems.ts": $$$$$$$$$8,
    "vtex/actions/cart/addOfferings.ts": $$$$$$$$$9,
    "vtex/actions/cart/clearOrderformMessages.ts": $$$$$$$$$10,
    "vtex/actions/cart/getInstallment.ts": $$$$$$$$$11,
    "vtex/actions/cart/removeItemAttachment.ts": $$$$$$$$$12,
    "vtex/actions/cart/removeItems.ts": $$$$$$$$$13,
    "vtex/actions/cart/removeOffering.ts": $$$$$$$$$14,
    "vtex/actions/cart/simulation.ts": $$$$$$$$$15,
    "vtex/actions/cart/updateAttachment.ts": $$$$$$$$$16,
    "vtex/actions/cart/updateCoupons.ts": $$$$$$$$$17,
    "vtex/actions/cart/updateGifts.ts": $$$$$$$$$18,
    "vtex/actions/cart/updateItemAttachment.ts": $$$$$$$$$19,
    "vtex/actions/cart/updateItemPrice.ts": $$$$$$$$$20,
    "vtex/actions/cart/updateItems.ts": $$$$$$$$$21,
    "vtex/actions/cart/updateProfile.ts": $$$$$$$$$22,
    "vtex/actions/cart/updateUser.ts": $$$$$$$$$23,
    "vtex/actions/masterdata/createDocument.ts": $$$$$$$$$24,
    "vtex/actions/masterdata/updateDocument.ts": $$$$$$$$$25,
    "vtex/actions/newsletter/subscribe.ts": $$$$$$$$$26,
    "vtex/actions/notifyme.ts": $$$$$$$$$27,
