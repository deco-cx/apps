...
import * as $$$4 from "./loaders/navbar.ts";
import * as $$$5 from "./loaders/user.ts";
import * as $$$6 from "./loaders/legacy/brands.ts";
import * as $$$7 from "./loaders/legacy/productList.ts";
import * as $$$8 from "./loaders/legacy/productDetailsPage.ts";
import * as $$$9 from "./loaders/legacy/relatedProductsLoader.ts";
import * as $$$10 from "./loaders/legacy/suggestions.ts";
...
import * as $$$17 from "./loaders/product/extensions/listingPage.ts";
...
import * as $$$23 from "./loaders/wishlist.ts";
import * as $$$24 from "./loaders/workflow/products.ts";
...
import * as $$$28 from "./loaders/collections/list.ts";
...
const manifest = {
  "loaders": {
    "vtex/loaders/cart.ts": $$$3,
    "vtex/loaders/categories/tree.ts": $$$1,
    "vtex/loaders/collections/list.ts": $$$28,
    "vtex/loaders/config.ts": $$$0,
    ...
    "vtex/loaders/legacy/brands.ts": $$$6,
    ...
    "vtex/loaders/legacy/relatedProductsLoader.ts": $$$9,
    "vtex/loaders/legacy/suggestions.ts": $$$10,
    "vtex/loaders/navbar.ts": $$$4,
