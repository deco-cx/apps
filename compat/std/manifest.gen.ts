...
import * as $1 from "./functions/requestToParam.ts";
import * as $2 from "./functions/vtexNavbar.ts";
...
import * as $10 from "./functions/vtexLegacyProductDetailsPage.ts";
...
import * as $$$5 from "./loaders/vtex/legacy/suggestions.ts";
import * as $$$6 from "./loaders/vtex/legacy/productList.ts";
...
const manifest = {
  "functions": {
    "deco-sites/std/functions/requestToParam.ts": $1,
    ...
    "deco-sites/std/functions/vtexNavbar.ts": $2,
