...
import * as $$$2 from "./loaders/path.ts";
...
import * as $$$6 from "./loaders/product/suggestions.ts";
...
const manifest = {
  "loaders": {
    ...
    "linx/loaders/pages.ts": $$$0,
    "linx/loaders/path.ts": $$$2,
    "linx/loaders/product/detailsPage.ts": $$$5,
    "linx/loaders/product/list.ts": $$$3,
    "linx/loaders/product/listingPage.ts": $$$4,
    "linx/loaders/product/suggestions.ts": $$$6,
  },
  "actions": {
    "linx/actions/cart/addCoupon.ts": $$$$$$$$$2,
