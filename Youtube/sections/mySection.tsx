    ...
    <div style={styles.container}>
      {!accessToken ? (
        <div style={styles.loginContainer}>
          ...
          <p>Faça login com sua conta do Google para visualizar seus canais do YouTube.</p>
          {authorizationUrl ? (
          ...
          <div style={styles.debug}>
            <p><strong>Estado:</strong> Não autenticado</p>
            <p><strong>URL de Autorização:</strong> {authorizationUrl ? authorizationUrl.substring(0, 50) + "..." : "Não configurada"}</p>
          </div>
        </div>
      ) : (
        <div>
          ...
          <div style={{ display: "flex", alignItems: "center", marginBottom: "20px" }}>
            <div>
              ...
              <p style={{ margin: 0, color: "#555" }}>Você está logado com sucesso no YouTube!</p>
            </div>
          </div>
          ...
          <div style={styles.debug}>
            ...
            <p><strong>Token:</strong> {accessToken ? accessToken.substring(0, 15) + '...' : 'Não disponível'}</p>
            <p><strong>Canais:</strong> {Array.isArray(channelData) ? channelData.length : 'Nenhum'}</p>
          </div>
          ...
          {Array.isArray(channelData) && channelData.length > 0 ? (
            ...
            <div style={{ padding: "20px", backgroundColor: "#f8f8f8", borderRadius: "8px" }}>
              <p>Nenhum canal encontrado. Isso pode ocorrer pelos seguintes motivos:</p>
              <ul>
              ...
              <a href={authorizationUrl} style={{ ...styles.loginButton, backgroundColor: "#4285F4" }}>
                Tentar novamente
              </a>
            </div>
          )}
