...
export default async function loader(
  ...
  const { captionId, format = "srt", translationLanguage, tokenYoutube } = props;
  ...
  try {
    ...
    if (!response.ok) {
      ...
      console.error(`Erro ao buscar texto da legenda: ${response.status} ${response.statusText}`, errorData);
      return null;
    }
 ...
 */
function parseSrtCaption(text: string): Array<{ index: number; startTime: string; endTime: string; text: string }> {
  const captions: Array<{ index: number; startTime: string; endTime: string; text: string }> = [];
 ...
 */
function parseSbvCaption(text: string): Array<{ index: number; startTime: string; endTime: string; text: string }> {
  const captions: Array<{ index: number; startTime: string; endTime: string; text: string }> = [];
 ...
 */
function parseVttCaption(text: string): Array<{ index: number; startTime: string; endTime: string; text: string }> {
  const captions: Array<{ index: number; startTime: string; endTime: string; text: string }> = [];
