...
import * as $$$0 from "./loaders/extension.ts";
...
import * as $$$7 from "./loaders/redirectsFromCsv.ts";
...
import * as $$$$$$$2 from "./matchers/negate.ts";
import * as $$$$$$$3 from "./matchers/userAgent.ts";
import * as $$$$$$$4 from "./matchers/always.ts";
import * as $$$$$$$5 from "./matchers/site.ts";
import * as $$$$$$$6 from "./matchers/environment.ts";
import * as $$$$$$$7 from "./matchers/host.ts";
import * as $$$$$$$8 from "./matchers/date.ts";
...
import * as $$$$$$$$1 from "./flags/flag.ts";
...
const manifest = {
  ...
  "loaders": {
    ...
    "website/loaders/extension.ts": $$$0,
    ...
    "website/loaders/redirectsFromCsv.ts": $$$7,
  ...
  "matchers": {
    "website/matchers/always.ts": $$$$$$$4,
    "website/matchers/cron.ts": $$$$$$$9,
    "website/matchers/date.ts": $$$$$$$8,
