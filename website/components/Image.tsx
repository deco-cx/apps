...
export const getOptimizedMediaUrl = (opts: OptimizationOptions) => {
  ...
  // VTEX CDN does not allow proxying through external services (returns 403).
  // Always apply native VTEX URL-based optimization regardless of the
  // BYPASS_PLATFORM_IMAGE_OPTIMIZATION flag.
  if (
