import {
  ...
  import { VNDAProduct, OfferProps } from "./types.ts"
...
export const toProduct = (
    ...
    const { price = 0, sale_price = 0 , available = false, instalments = [] } = product
    const offers = toOffer({ price, sale_price, available_quantity: 1, available, installments: instalments });
