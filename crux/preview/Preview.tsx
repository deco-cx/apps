...
const BASE_CRUX_URL = "https://lookerstudio.google.com/embed/reporting/bbc5698d-57bb-4969-9e07-68810b9fa348/page/keDQB"
...
export default function Preview(app: AppRuntime<BaseContext, App["state"]>){
    ...
    return(
        <div class="h-full">
            ...
            `}}></style>
            <iframe width="100%" height="100%" src={url} frameBorder="0" style="border:0" allowFullScreen></iframe>
        </div>
    )
}